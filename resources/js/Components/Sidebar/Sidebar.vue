...
<template>
    ...
    <aside
        ...
        "
        :class="[
            'fixed inset-y-0 z-40 bg-white dark:bg-surface-950 transition-colors duration-200 flex flex-col border-r border-transparent dark:border-surface-700 shadow-[0_4px_16px_rgba(244,63,93,0.4)] dark:shadow-none overflow-y-auto',
            {
